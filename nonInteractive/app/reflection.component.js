        ...
        execute: function() {
            ReflectionComponent = (function () {
                function ReflectionComponent() {
                    ...
                    this.paragraphs = [
                        "Mijn reflectie over al deze kleine activiteiten is eigenlijk een samenstelling van allemaal kleine dingen die ik op elke ervaring heb geleerd. Het is als het waren een lapendeken van ervaringen en verworven ideëen.",
